"""Baseline model using Cluster-GCN: An Efficient Algorithm for Training Deep and Large Graph Convolutional Networks. Copyright: SNAP-Stanford OGB"""
import os
...
cluster_data = ClusterData(data, num_parts=args.num_partitions,
                               recursive=False, save_dir='/Users/zliu/Desktop/pythonProject/SubgraphSampler/utils/dataset/baseline/subgraphs')
